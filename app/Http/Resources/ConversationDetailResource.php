    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'customer' => [
                ...
                'avatar' => $this->customer->avatar ? Storage::disk('public')->url($this->customer->avatar) : null,
                'role' => $this->customer->role,
            ],
            'vendor' => [
                'id' => $this->vendor->id,
                'name' => $this->vendor->name,
                'avatar' => $this->vendor->avatar ? Storage::disk('public')->url($this->vendor->avatar) : null,
