        ...
        if ($user->latestVendorApplication) {
            ...
            $vendorApplication = [
                ...
                'ghana_card_front' => $app->ghana_card_front
                    ? Storage::disk('public')->url($app->ghana_card_front)
                    : null,
                'ghana_card_back' => $app->ghana_card_back
                    ? Storage::disk('public')->url($app->ghana_card_back)
                    : null,
                ...
                'business_certificate_document' => $app->business_certificate_document
                    ? Storage::disk('public')->url($app->business_certificate_document)
                    : null,
                'tin_document' => $app->tin_document
                    ? Storage::disk('public')->url($app->tin_document)
                    : null,

                // Step 3B: Unregistered Vendor Documents
                'selfie_image' => $app->selfie_image
                    ? Storage::disk('public')->url($app->selfie_image)
                    : null,
                'proof_of_business' => $app->proof_of_business
                    ? Storage::disk('public')->url($app->proof_of_business)
                    : null,
