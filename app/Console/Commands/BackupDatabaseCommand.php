...
class BackupDatabaseCommand extends Command
{
     ...
     */
    protected $signature = 'backup:local';

    /**
     * The console command description.
     */
    protected $description = 'Create a database backup and store it locally in the backup/ directory';
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            if (! file_exists($filePath) || filesize($filePath) === 0) {
                ...
                Log::error('Local database backup failed: file not created.', [
            ...
            $this->info("Backup saved: {$filePath} ({$fileSize})");
            Log::info('Local database backup created successfully.', [
                'filename' => $filename,
                'path' => $filePath,
                'size' => $fileSize,
            ]);
            ...
            Log::error('Local database backup failed: '.$e->getMessage());
