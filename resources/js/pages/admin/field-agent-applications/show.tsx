                ...
                <Stack spacing={3}>
                            ...
                            <Stack direction="row" spacing={1}>
                                ...
                                <Dialog open={rejectOpen} onOpenChange={setRejectOpen}>
                                    ...
                                    <DialogContent>
                                        ...
                                        <Box component="form" onSubmit={onReject}>
                                            <Stack spacing={2}>
                                                <Textarea
                                                    rows={4}
                    ...
                    >
                        ...
                        <Section title="Location">
                            ...
                            <Field label="Landmark" value={application.location} />
                        </Section>
                        <Section title="Identity">
                            <Field label="Ghana card number" value={application.ghana_card_number} />
                        </Section>
                        <Section title="Review">
                            <Field label="Status" value={STATUS_LABEL[application.status] ?? application.status} />
                            {application.reviewer && (
                                <Field label="Reviewed by" value={application.reviewer.name} />
                            )}
                            ...
                            {application.rejection_reason && (
                                <Field label="Reason" value={application.rejection_reason} />
                            )}
                        </Section>
                    </Box>
