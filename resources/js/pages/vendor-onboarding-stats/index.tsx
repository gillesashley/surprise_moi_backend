...
export default function VendorOnboardingStatsPage({
    stats,
}: {
    stats: VendorOnboardingStats;
}) {
    return (
            ...
            >
                ...
                >
                    ...
                    <Card sx={{ py: 2, gap: 1 }}>
                        ...
                        <CardContent>
                            <Box sx={{ fontSize: '1.5rem', fontWeight: 700 }}>
                                GHS{' '}
                                {formatCurrency(stats.total_onboarding_fees)}
                            </Box>
                            <Typography
                                sx={{
                                    fontSize: '0.75rem',
                            ...
                            >
                                From all approved applications
                            </Typography>
                        </CardContent>
                    </Card>
                </Box>
                ...
                <Box>
                    <Typography
                        sx={{ fontSize: '1rem', fontWeight: 600, mb: 1 }}
                    >
                        Tier 2 — Individual / Unregistered
                    </Typography>
                    <Box
                        sx={{
                            display: 'grid',
