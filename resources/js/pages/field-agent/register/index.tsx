                    ...
                    >
                        ...
                        >
                            ...
                            {step === 2 && (
                                <Stack spacing={2.25}>
                                    <Stack spacing={1}>
                                        <Label htmlFor="ghana_card_number">
                                            Ghana card number
                                        </Label>
                                        <Input
                                    ...
                                    <Stack spacing={1}>
                                        <Label htmlFor="ghana_card_image">
                                            Ghana card — front (max 5MB)
                                        </Label>
                                        <Input
                                            id="ghana_card_image"
                                            type="file"
                                        ...
                                        />
                                        <InputError
                                            message={errors.ghana_card_image}
                                        />
                                    </Stack>
                                    <Stack spacing={1}>
                                        <Label htmlFor="ghana_card_back_image">
                                            Ghana card — back (max 5MB)
                                        </Label>
                                        <Input
