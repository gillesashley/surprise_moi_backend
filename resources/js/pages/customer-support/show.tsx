                ...
                >
                    ...
                    <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                        ...
                        <Button
                            ...
                            disabled={isClosed || !preferredPhone}
                        >
                            <Send
                                style={{
                                    marginRight: 4,
                    ...
                    >
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Calls, messages, and check-ins, newest first
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                {timeline.length === 0 ? (
                                    ...
                                    >
                                        No activity yet. Log a call or send an
                                        SMS to get started.
                                    </Typography>
                                ) : (
                                    <Box
                ...
                <Dialog open={logOpen} onOpenChange={setLogOpen}>
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Record a call, check-in, or other touchpoint.
                            </DialogDescription>
                        </DialogHeader>
                        <Box
                            sx={{
                        ...
                        >
                            <Box>
                                ...
                                <Select
                                    value={logForm.data.channel}
                                    onValueChange={(v) =>
                                        logForm.setData('channel', v)
                                    }
                                >
                            ...
                            <Box>
                                ...
                                <Select
                                    value={logForm.data.direction}
                                    onValueChange={(v) =>
                                        logForm.setData('direction', v)
                                    }
                                >
                ...
                <Dialog open={smsOpen} onOpenChange={setSmsOpen}>
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                The message is sent via Kairos Afrika. Delivery
                                status appears in the timeline.
                            </DialogDescription>
                        </DialogHeader>
                        <Box
                            sx={{
                        ...
                        >
                            ...
                            <Box>
                                ...
                                <Select
                                    value={smsForm.data.template_key}
                            ...
                            <Box>
                                ...
                                <Textarea
                                    ...
                                    onChange={(e) =>
                                        smsForm.setData('body', e.target.value)
                                    }
                                    rows={4}
                ...
                <Dialog open={closeOpen} onOpenChange={setCloseOpen}>
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Provide a closure note explaining the
                                resolution.
                            </DialogDescription>
                        </DialogHeader>
                        <Box
                ...
                <Dialog open={assignOpen} onOpenChange={setAssignOpen}>
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Move this ticket to another admin or super
                                admin.
                            </DialogDescription>
                        </DialogHeader>
                        <Box
                        ...
                        >
                            ...
                            <Select
                                ...
                                onValueChange={(v) =>
                                    assignForm.setData('assigned_to', Number(v))
                                }
                            >
