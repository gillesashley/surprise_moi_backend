...
export function useEchoNotifications() {
    ...
    useEffect(() => {
        ...
        channel.listen('vendor.approved', (event: VendorApprovalEvent) => {
            if (isDevelopment) {
                console.log(
                    '✅ [useEchoNotifications] Vendor approved:',
                    event,
                );
            }
        ...
        channel.listen('vendor.rejected', (event: VendorApprovalEvent) => {
            if (isDevelopment) {
                console.log(
                    '✅ [useEchoNotifications] Vendor rejected:',
                    event,
                );
            }
